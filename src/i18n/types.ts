...
export interface TranslationKeys {
  ...
  category: {
    ...
    sortBy: string;
    sortPopular: string;
    sortBestDeals: string;
    sortHighestDiscount: string;
    sortPriceAsc: string;
    sortPriceDesc: string;
    sortNewest: string;
    highlightCta: string;
    topStoresInCategory: string;
    bestDeals: string;
    storesWithProducts: string;
    ...
    starRating: string;
    starsAndAbove: string;
    dealType: string;
    dealVoucher: string;
    dealCoupon: string;
    dealCashback: string;
    dealInsurance: string;
    dealService: string;
    memberBenefits: string;
    benefitClubExclusive: string;
    benefitBonusPoints: string;
    benefitSpecialPrice: string;
    highlightTitleFood: string;
    highlightSubtitleFood: string;
    highlightTitleShopping: string;
    highlightSubtitleShopping: string;
    highlightTitleEntertainment: string;
    highlightSubtitleEntertainment: string;
    highlightTitleTravel: string;
    highlightSubtitleTravel: string;
    highlightTitleHealth: string;
    highlightSubtitleHealth: string;
    highlightTitleEducation: string;
    highlightSubtitleEducation: string;
    highlightTitleTech: string;
