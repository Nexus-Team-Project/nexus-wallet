/**
 * Footer — rebuilt from the mobile reference (footer-mobile-code.tsx).
 *
 * The mobile layout is the ONLY layout: every `md:` desktop override was
 * removed, so all viewports render the mobile-first classes below.
 *
 * Layout:
 *   Row 1 (full width): logo + address + language selector  (col-span-2)
 *   Row 2: "Products" column | "Developers" column           (grid-cols-2)
 *   Row 3: "Resources" column | "Company" column
 *   Bottom bar: vertical, centered — copyright on top, then the 3 legal
 *   links in one horizontal row (flex-col items-center gap-4).
 */
...
export default function Footer({ light = false }: { light?: boolean }) {
  ...
  // Close the language dropdown on any click outside of it
  useEffect(() => {
  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [t.footer.documentation, t.footer.apiReference, t.footer.apiChangelog],
    },
    {
      title: t.footer.resources,
      links: [t.footer.blog, t.footer.supportCenter, t.footer.contactSales],
    },
    {
      title: t.footer.company,
      links: [t.footer.aboutNexus, t.footer.jobs, t.footer.newsroom],
    },
  ];

  return (
    <footer className="relative py-24 bg-white">
      {/* Diagonal slanted background — starts 100px above the footer */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        {/* 2-column grid at every viewport (mobile-first, no desktop override) */}
        <div className="grid grid-cols-2 gap-12 mb-16">

          {/* Row 1, full width — logo, address, language selector */}
          <div className="col-span-2">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                {/* Dropdown arrow — physically on the right, rotates when open */}
                <svg
                  width="10"
                  height="6"
                  viewBox="0 0 10 6"
            ...
            <div key={category.title}>
              ...
              <ul className="space-y-4">
                {category.links.map((link) => {
                  ...
                  // Changelog routes via React Router
                  ...
                  // Documentation & API Reference go to the external docs site
                  ...
                  // All remaining links are placeholders
                  return (
                    <li key={link}>
                      <a
                        href="#"
        ...
        {/* Bottom bar — stacked and centered at every viewport */}
        <div className="border-t border-slate-200 pt-8 flex flex-col justify-between items-center gap-4">
